...
!
   SUBROUTINE Z26_Z30
     ...
     iron_array(1)%mass_defect = -56.2538
     iron_array(1)%atom_percent = 5.845
     iron_array(1)%zaid = "26054.80c"

     iron_array(2)%z = 26
     iron_array(2)%a = 56
     iron_array(2)%symbol ="Fe-56 "
     iron_array(2)%mass_defect = -60.6063
     iron_array(2)%atom_percent = 91.754
     iron_array(2)%zaid = "26056.80c"

     iron_array(3)%z = 26
     iron_array(3)%a = 57
     iron_array(3)%symbol ="Fe-57 "
     iron_array(3)%mass_defect = -60.1811
     iron_array(3)%atom_percent = 2.119
     iron_array(3)%zaid = "26057.80c"

     iron_array(4)%z = 26
     iron_array(4)%a = 58
     iron_array(4)%symbol ="Fe-58 "
     iron_array(4)%mass_defect = -62.1544
     iron_array(4)%atom_percent = 0.282
     iron_array(4)%zaid = "26058.80c"

     !Calculate isotopic mass for Iron
     DO i=1,fe_size
          holder = iron_array(i)%a + (iron_array(i)%mass_defect/931.494)
     ...
     cobalt_array(1)%mass_defect = -62.2290
     cobalt_array(1)%atom_percent = 100.0
     cobalt_array(1)%zaid = "27059.80c"

     !Calculate isotopic mass for Cobalt
     DO i=1,co_size
          holder = cobalt_array(i)%a + (cobalt_array(i)%mass_defect/931.494)
     ...
     nickel_array(1)%mass_defect = -60.2281
     nickel_array(1)%atom_percent = 68.077
     nickel_array(1)%zaid = "28058.80c"

     nickel_array(2)%z = 28
     nickel_array(2)%a = 60
     nickel_array(2)%symbol ="Ni-60 "
     nickel_array(2)%mass_defect = -64.4725
     nickel_array(2)%atom_percent = 26.223
     nickel_array(2)%zaid = "28060.80c"

     nickel_array(3)%z = 28
     nickel_array(3)%a = 61
     nickel_array(3)%symbol ="Ni-61 "
     nickel_array(3)%mass_defect = -64.2212
     nickel_array(3)%atom_percent = 1.1399
     nickel_array(3)%zaid = "28061.80c"

     nickel_array(4)%z = 28
     nickel_array(4)%a = 62
     nickel_array(4)%symbol ="Ni-62 "
     nickel_array(4)%mass_defect = -66.7458
     nickel_array(4)%atom_percent = 3.6346
     nickel_array(4)%zaid = "28062.80c"

     nickel_array(5)%z = 28
     nickel_array(5)%a = 64
     nickel_array(5)%symbol ="Ni-64 "
     nickel_array(5)%mass_defect = -67.0984
     nickel_array(5)%atom_percent = 0.9255
     nickel_array(5)%zaid = "28064.80c"

     !Calculate isotopic mass for Nickel
     DO i=1,ni_size
          holder = nickel_array(i)%a + (nickel_array(i)%mass_defect/931.494)
     ...
     copper_array(1)%mass_defect = -65.5792
     copper_array(1)%atom_percent = 69.15
     copper_array(1)%zaid = "29063.80c"

     copper_array(2)%z = 29
     copper_array(2)%a = 65
     copper_array(2)%symbol ="Cu-65 "
     copper_array(2)%mass_defect = -67.2633
     copper_array(2)%atom_percent = 30.85
     copper_array(2)%zaid = "29065.80c"

     !Calculate isotopic mass for Copper
     DO i=1,cu_size
          holder = copper_array(i)%a + (copper_array(i)%mass_defect/931.494)
     ...
     zinc_array(1)%mass_defect = -66.0036
     zinc_array(1)%atom_percent = 49.17
     zinc_array(1)%zaid = "30064.80c"

     zinc_array(2)%z = 30
     zinc_array(2)%a = 66
     zinc_array(2)%symbol ="Zn-66 "
     zinc_array(2)%mass_defect = -68.8990
     zinc_array(2)%atom_percent = 27.73
     zinc_array(2)%zaid = "30066.80c"

     zinc_array(3)%z = 30
     zinc_array(3)%a = 67
     zinc_array(3)%symbol ="Zn-67 "
     zinc_array(3)%mass_defect = -67.8800
     zinc_array(3)%atom_percent = 4.04
     zinc_array(3)%zaid = "30067.80c"

     zinc_array(4)%z = 30
     zinc_array(4)%a = 68
     zinc_array(4)%symbol ="Zn-68 "
     zinc_array(4)%mass_defect = -70.0068
     zinc_array(4)%atom_percent = 18.45
     zinc_array(4)%zaid = "30068.80c"

     zinc_array(5)%z = 30
     zinc_array(5)%a = 70
     zinc_array(5)%symbol ="Zn-70 "
     zinc_array(5)%mass_defect = -69.5646
     zinc_array(5)%atom_percent = 0.61
     zinc_array(5)%zaid = "30070.80c"

     !Calculate isotopic mass for Zinc
     DO i=1,zn_size
          holder = zinc_array(i)%a + (zinc_array(i)%mass_defect/931.494)
