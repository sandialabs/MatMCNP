...
!
   SUBROUTINE Z51_Z55
     ...
     antimony_array(1)%mass_defect = -89.5998
     antimony_array(1)%atom_percent = 57.21
     antimony_array(1)%zaid = "51121.80c"

     antimony_array(2)%z = 51
     antimony_array(2)%a = 123
     antimony_array(2)%symbol ="Sb-123"
     antimony_array(2)%mass_defect = -89.2261
     antimony_array(2)%atom_percent = 42.79
     antimony_array(2)%zaid = "51123.80c"

     !Calculate isotopic mass for Antimony
     DO i=1,sb_size
          holder = antimony_array(i)%a + (antimony_array(i)%mass_defect/931.494)
     ...
     tellurium_array(7)%zaid = "52128.80c"
     ...
     tellurium_array(8)%zaid = "52130.80c"

     !Calculate isotopic mass for Tellurium
     DO i=1,te_size
          holder = tellurium_array(i)%a + (tellurium_array(i)%mass_defect/931.494)
     ...
     iodine_array(1)%mass_defect = -88.9847
     iodine_array(1)%atom_percent = 100.0
     iodine_array(1)%zaid = "53127.80c"

     !Calculate isotopic mass for Iodine
     DO i=1, i_size
          holder = iodine_array(i)%a + (iodine_array(i)%mass_defect/931.494)
     ...
     xenon_array(1)%mass_defect = -87.6612
     xenon_array(1)%atom_percent = 0.0952
     xenon_array(1)%zaid = "54124.80c"

     xenon_array(2)%z = 54
     xenon_array(2)%a = 126
     xenon_array(2)%symbol ="Xe-126"
     xenon_array(2)%mass_defect = -89.1462
     xenon_array(2)%atom_percent = 0.0890
     xenon_array(2)%zaid = "54126.80c"
     ...
     xenon_array(5)%zaid = "54130.80c"

     xenon_array(6)%z = 54
     xenon_array(6)%a = 131
     xenon_array(6)%symbol ="Xe-131"
     xenon_array(6)%mass_defect = -88.4136
     xenon_array(6)%atom_percent = 21.232 
     xenon_array(6)%zaid = "54131.80c"
     ...
     xenon_array(7)%zaid = "54132.80c"

     xenon_array(8)%z = 54
     xenon_array(8)%a = 134
     xenon_array(8)%symbol ="Xe-134"
     xenon_array(8)%mass_defect = -88.1245
     xenon_array(8)%atom_percent = 10.4357
     xenon_array(8)%zaid = "54134.80c"
     ...
     xenon_array(9)%zaid = "54136.80c"

     !Calculate isotopic mass for Xenon
     DO i=1,xe_size
          holder = xenon_array(i)%a + (xenon_array(i)%mass_defect/931.494)
     ...
     cesium_array(1)%zaid = "55133.80c"

     !Calculate isotopic mass for Cesium
     DO i=1, cs_size
          holder = cesium_array(i)%a + (cesium_array(i)%mass_defect/931.494)
