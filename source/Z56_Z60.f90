...
!
   SUBROUTINE Z56_Z60
     ...
     lanthanum_array(1)%mass_defect = -86.5191
     lanthanum_array(1)%atom_percent = 0.08881
     lanthanum_array(1)%zaid = "57138.00c"

     lanthanum_array(2)%z = 57
     lanthanum_array(2)%a = 139
     lanthanum_array(2)%symbol ="La-139"
     lanthanum_array(2)%mass_defect = -87.2262
     lanthanum_array(2)%atom_percent = 99.9119
     lanthanum_array(2)%zaid = "57139.00c"

     !Calculate isotopic mass for Lanthanum
     DO i=1,la_size
          holder = lanthanum_array(i)%a + (lanthanum_array(i)%mass_defect/MeV_amu)
     ...
     praseodymium_array(1)%mass_defect = -86.0156
     praseodymium_array(1)%atom_percent = 100.0
     praseodymium_array(1)%zaid = "59141.00c"

     !Calculate isotopic mass for Praseodymium
     DO i=1, pr_size
          holder = praseodymium_array(i)%a + (praseodymium_array(i)%mass_defect/MeV_amu)
