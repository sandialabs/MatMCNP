...
!
   SUBROUTINE Z11_Z15
     ...
     sodium_array(1)%zaid = "11023.80c"

     !Calculate isotopic mass for Sodium
     DO i=1, na_size
          holder = sodium_array(i)%a + (sodium_array(i)%mass_defect/931.494)
     ...
     magnesium_array(1)%zaid = "12024.80c"
     ...
     magnesium_array(2)%zaid = "12025.80c"
     ...
     magnesium_array(3)%zaid = "12026.80c"

     !Calculate isotopic mass for Magnesium
     DO i=1,mg_size
          holder = magnesium_array(i)%a + (magnesium_array(i)%mass_defect/931.494)
     ...
     aluminum_array(1)%mass_defect = -17.1967
     aluminum_array(1)%atom_percent = 100.0
     aluminum_array(1)%zaid = "13027.80c"

     !Calculate isotopic mass for Aluminum
     DO i=1, al_size
          holder = aluminum_array(i)%a + (aluminum_array(i)%mass_defect/931.494)
     ...
     silicon_array(1)%zaid = "14028.80c"
     ...
     silicon_array(2)%zaid = "14029.80c"
     ...
     silicon_array(3)%zaid = "14030.80c"

     !Calculate isotopic mass for Silicon
     DO i=1,si_size
          holder = silicon_array(i)%a + (silicon_array(i)%mass_defect/931.494)
     ...
     phosphorus_array(1)%zaid = "15031.80c"

     !Calculate isotopic mass for Phosphorus
     DO i=1, p_size
          holder = phosphorus_array(i)%a + (phosphorus_array(i)%mass_defect/931.494)
