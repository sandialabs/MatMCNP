...
!
   SUBROUTINE Z16_Z20
     ...
     sulfur_array(4)%zaid = "16036.80c"

     !Calculate isotopic mass for Sulfur
     DO i=1,s_size
          holder = sulfur_array(i)%a + (sulfur_array(i)%mass_defect/931.494)
     ...
     chlorine_array(1)%zaid = "17035.80c"
     ...
     chlorine_array(2)%zaid = "17037.80c"

     !Calculate isotopic mass for Chlorine
     DO i=1,cl_size
          holder = chlorine_array(i)%a + (chlorine_array(i)%mass_defect/931.494)
     ...
     argon_array(1)%zaid = "18036.80c"

     argon_array(2)%z = 18
     argon_array(2)%a = 38
     argon_array(2)%symbol ="Ar-38 "
     argon_array(2)%mass_defect = -34.7147
     argon_array(2)%atom_percent = 0.0629
     argon_array(2)%zaid = "18038.80c"
     ...
     argon_array(3)%zaid = "18040.80c"

     !Calculate isotopic mass for Argon
     DO i=1,ar_size
          holder = argon_array(i)%a + (argon_array(i)%mass_defect/931.494)
     ...
     potassium_array(1)%mass_defect = -33.807
     potassium_array(1)%atom_percent = 93.2581
     potassium_array(1)%zaid = "19039.80c"
     ...
     potassium_array(2)%zaid = "19040.80c"
     ...
     potassium_array(3)%zaid = "19041.80c"

     !Calculate isotopic mass for Potassium
     DO i=1,k_size
          holder = potassium_array(i)%a + (potassium_array(i)%mass_defect/931.494)
     ...
     calcium_array(1)%zaid = "20040.80c"
